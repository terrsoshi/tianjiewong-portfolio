...
class Project(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        elif self.end_date is None or self.end_date > timezone.now().date():
            self.current = True
        else:
            self.current = False
...
class Subject(models.Model):
    name = models.CharField(max_length=200)
    semester = models.ForeignKey('Semester', on_delete=models.RESTRICT, null=True)
...
class Semester(models.Model):
    ...
    education = models.ForeignKey('Education', on_delete=models.RESTRICT, null=True)
    start_date = models.DateField()
